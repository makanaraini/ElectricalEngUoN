...
\begingroup
\setlength{\cftbeforetoctitleskip}{-1em}  % Reduce space before TOC title
\setlength{\cftaftertoctitleskip}{0.5em}  % Reduce space after TOC title
\setlength{\cftbeforechapskip}{0.2em}     % Reduce space before chapters in TOC
\setlength{\cftbeforesecskip}{0.1em}      % Reduce space before sections in TOC
\renewcommand{\cftdotsep}{1}              % Dot spacing in TOC

\tableofcontents
\endgroup


% Ensure no empty pages after TOC
\begingroup
\pagestyle{empty}
\cleardoublepage
\endgroup
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Stab5.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Stab6.png}
    \caption{output due to $V^{+}$}
\end{figure}
\[
V_{o2}(t) = V_m(t) + I R_f
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Stab7.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square1.png}
    \caption{}
\end{figure}
\textbf{Circuit:}  
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square2.png}
    \caption{}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square3.png}
    \caption{}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square7.png}
    \caption{}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square9.png}
    \caption{}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square10.png}
    \caption{}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square11.png}
    \caption{}
\end{figure}
\[
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square12.png}
    \caption{}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square13.png}
    \caption{}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square14.png}
    \caption{}
\end{figure}
...
\begin{enumerate}
    ...
    \item When load resistance is high and switching speeds and feed-through spikes are important for low input signals, then the series-shunt chopper offers the best performance.
...
\begin{enumerate}
    ...
    \item The figure below is a chopper stabilized amplifier with an input signal $V_i = 20mV$ d.c. The maximum drift input voltage $V_{io} = 0.001 \cos(2\pi f t)$ volts assumed to be sinusoidal when referred to the input. For the circuit, determine the drift voltage magnitude at the output point $Y$ if the input to the a.c. shunt amplifying circuit is 10dB.\\
\end{enumerate}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Square15.png}
    \caption{}
\end{figure} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{BasicLog.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{Shegone.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{MatchedAmp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{DiffAmp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{DueAmp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{MarkAmp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{TransitLife.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Psalm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{Accurate.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Antilog.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{MatchedAntilog.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Junior.png}
    \caption{}
    \label{fig:question_image}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{page1.png}
    \caption{(a)}
    \label{fig:question_image}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{page2.png}
    \caption{(b)}
    \label{fig:question_image}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{page3.png}
    \caption{(c)}
    \label{fig:question_image}
\end{figure}
\newpage
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{CircuitImplementation.png} % Adjust width as necessary
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{Simplified.png} % Adjust width as necessary
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{Improvement.png} % Adjust width as necessary
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{CELL.png} % Adjust width as necessary
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{II.png} % Adjust width as necessary
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{Re.png} % Adjust width as necessary
    \caption{}
    \label{fig:Re}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{Case2.png} % Adjust width as necessary
    \caption{}
    \label{fig:Case2}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Practical.png} % Adjust width as necessary
    \caption{}
    \label{fig:Practical}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{NewScheme.png} % Replace with your image path
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Effect.png} % Adjust width as necessary
    \caption{}
    \label{fig:Practical}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{Multiplier.png}
    \caption{Gilbert’s multiplier cell}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Precond.png}
    \caption{Preconditioning/Predistortion Circuit}
    \label{fig:precond}
\end{figure}
\subsection{Extending the Ranges of Signals \( V_1 \) and \( V_2 \)}

We are able to extend the ranges of the signals \( V_1 \) and \( V_2 \) by \( +10V \).
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{ExtendRange.png}
    \caption{}
    \label{fig:extendrange}
\end{figure}
...
\subsection{Solving for \(I_1\) and \(I_2\)}
...
\subsection{Considering the Output Voltage \(V_o\)}
...
\begin{tikzpicture}[auto, node distance=2.5cm, thick, >=latex]
    ...
    \node (block) [draw, rectangle, right=of input, minimum width=3cm, minimum height=1.5cm] 
    {Pre-Conditioning Circuit};

    % Output node
    \node (output) [right=of block] {Output: $2V_T \tanh^{-1} \left(\frac{K V_1}{I_0}\right)$};
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{SquareRooter.png}
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{MeanSquare.png}
        \caption{Mean Square}
...
\begin{figure}[H] % H places the figure exactly where it appears in the code
    \centering
    \includegraphics[width=0.15\textwidth]{zener.png} % Adjust width as needed
...
\begin{figure}[H] % 'H' to place the figure exactly here
    \centering
    \includegraphics[width=0.16\textwidth]{zener2.png} % Adjust width as necessary
...
\begin{figure}[H] % 'H' to place the figure exactly here
    \centering
    \includegraphics[width=0.4\textwidth]{Opoa.png} % Adjust width as necessary
    \caption{Accurate model Zener reference model.}
    \label{fig:accurate-zener-reference} % Label for referencing
\end{figure}
...
\begin{figure}[H] % Place exactly here, requires 'float' package
    ...
    \hfill
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=0.4\textwidth]{switching.png}
        \caption{Switching Regulator}
        \label{fig:switching-regulator}
    \end{subfigure}
    \caption{Types of DC Voltage Regulators}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{SeriesReg.png} % Replace with the actual image file name
...
\begin{enumerate}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Question.png}
    \caption{Regulator}
    \label{fig:question_image}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Question2.png}
    \caption{Regulator}
    \label{fig:question_image}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{BasicLog.png}
    \caption{Basic diode Log Amp}
    \label{fig:question_image}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Shegone.png}
    \caption{Basic transistor Log Amp}
    \label{fig:question_image}
\end{figure}
Using Eber's Moll relations:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{DiffAmp.png}
    \caption{Considering first the difference amplifie}
    \label{fig:question_image}
\end{figure}
Since A3 is operated in linear region, we apply superposition theorem i.e. net response due to sum of individual responses
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{DueAmp.png}
    \caption{Output due to $V_a$ only}
    \label{fig:question_image}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{MarkAmp.png}
    \caption{Output due to $V_b$ only}
    \label{fig:question_image}
\end{figure}
\[
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Psalm.png}
    \caption{An improved Matched Transistor Log Amp with constant current source}
    \label{fig:question_image}
\end{figure}
...
\begin{figure}[H]  % Ensure the figure appears exactly here
    \begin{minipage}[b]{0.48\textwidth}  % First minipage for the image
        % tcolorbox with image
        \begin{tcolorbox}[width=\linewidth, colback=white, boxrule=0.5mm, colframe=black, rounded corners]

            \includegraphics[width=\linewidth]{Lectures/CascodeLect1.png}  % Image path
            \small \textbf{Figure Explanation:} This image illustrates the Cascode configuration, which improves both gain and bandwidth.
        \end{tcolorbox}
    \end{minipage}%
    \hfill  % Create space between the minipages
    \begin{minipage}[b]{0.48\textwidth}  % Second minipage for the text
        \small
        \subsubsection*{Comparison}

\subsubsection*{Common Emitter vs. Cascode:}
The Common Emitter (CE) configuration provides high gain but suffers from limited high-frequency performance due to Miller capacitance. The cascode configuration improves high-frequency performance and stability by stacking a Common Base (CB) stage on top of the CE stage.

\subsubsection*{Common Base vs. Cascode:}
While the Common Base (CB) configuration offers good high-frequency performance and isolation, it generally has lower voltage gain. The cascode configuration combines the high voltage gain of the CE stage with the high-frequency performance of the CB stage, offering the best of both worlds.

\subsubsection*{Summary}

The \textbf{cascode configuration} is a powerful amplifier design that enhances performance by leveraging the strengths of both the Common Emitter and Common Base configurations. It excels in applications requiring high gain, excellent isolation, and superior high-frequency performance.
...
\subsection{Illustrations}
\begin{figure}[H]  % Ensure the figure appears exactly here
    \begin{minipage}[b]{0.58\textwidth}  % First minipage for the image
        % tcolorbox with image
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{Lectures/Lecture2AC.png} % Replace with your image file
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.3\textwidth]{OpAMP.png} % Replace with your image file
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{Lectures/LM741.png}
    \caption{Centered image in a figure environment.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{Lectures/ExampleLM.png}
    \caption{Centered image in a figure environment.}
    \label{fig:example_centered}
\end{figure}
...
\begin{figure}[H] % Ensure the figure appears exactly here
    \begin{minipage}[b]{0.48\textwidth} % First minipage for the image
        \begin{tcolorbox}[width=\textwidth, colback=white, boxrule=0.5mm, colframe=black, rounded corners]
            \includegraphics[width=\textwidth, height=5cm, keepaspectratio]{Lectures/SimplifiedLM.png} % Image path with fixed height
            \centering
            {\footnotesize \textbf{Simplified, Conceptual Schematic Diagram of the 741 Op Amp}}
        \end{tcolorbox}
    \end{minipage}%
    \hfill % Space between the minipages
    \begin{minipage}[b]{0.48\textwidth} % Second minipage for the image
        \begin{tcolorbox}[width=\textwidth, colback=white, boxrule=0.5mm, colframe=black, rounded corners]
            \includegraphics[width=\textwidth, height=5cm, keepaspectratio]{Lectures/SimplifiedLM1.png} % Image path with fixed height
            \centering
            {\footnotesize \textbf{DC Analysis of the 741 Op Amp}}
        \end{tcolorbox}
    \end{minipage}
    \caption{Analyis 1 \& 2}
    \label{fig:741_side_by_side}
\end{figure}
\begin{figure}[H] % Ensure the figure appears exactly here
    \begin{minipage}[b]{0.48\textwidth} % First minipage for the image
        \begin{tcolorbox}[width=\textwidth, colback=white, boxrule=0.5mm, colframe=black, rounded corners]
            \includegraphics[width=\textwidth, height=5cm, keepaspectratio]{Lectures/SimplifiedLM2.png} % Image path with fixed height
            \centering
            {\footnotesize \textbf{Simplified Schematic of the 741 Op Amp with Idealized Biasing}}
        \end{tcolorbox}
    \end{minipage}%
    \hfill % Space between the minipages
    \begin{minipage}[b]{0.48\textwidth} % Second minipage for the image
        \begin{tcolorbox}[width=\textwidth, colback=white, boxrule=0.5mm, colframe=black, rounded corners]
            \includegraphics[width=\textwidth, height=5cm, keepaspectratio]{Lectures/SimplifiedLM3.png} % Image path with fixed height
            \centering
            {\footnotesize \textbf{ Input Stage Biasing of the 741 Op Amp}}
        \end{tcolorbox}
    \end{minipage}
    \caption{Analyis 3 \& 4}
    \label{fig:741_side_by_side}
...
\begin{figure}[H] % Ensure the figure appears exactly here
    \begin{minipage}[b]{0.48\textwidth} % First minipage for the image
        \begin{tcolorbox}[width=\textwidth, colback=white, boxrule=0.5mm, colframe=black, rounded corners]
            \includegraphics[width=\textwidth, height=5cm, keepaspectratio]{Lectures/SimplifiedLM4.png} % Image path with fixed height
            \centering
            {\footnotesize \textbf{Darlington Gain Stage Biasing}}
        \end{tcolorbox}
    \end{minipage}%
    \hfill % Space between the minipages
    \begin{minipage}[b]{0.48\textwidth} % Second minipage for the image
        \begin{tcolorbox}[width=\textwidth, colback=white, boxrule=0.5mm, colframe=black, rounded corners]
            \includegraphics[width=\textwidth, height=5cm, keepaspectratio]{Lectures/SimplifiedLM5.png} % Image path with fixed height
            \centering
            {\footnotesize \textbf{Output Stage Biasing of the 741 Op Amp}}
        \end{tcolorbox}
    \end{minipage}
    \caption{Analyis 5 \& 6}
    \label{fig:741_side_by_side}
...
\begin{itemize}
    \item \textbf{Low \( R_{DS\_on} \):} Reduces on-state error.
    \item \textbf{High \( R_{DS\_off} \):} Minimizes off-state error.
...
Based on our analysis and exercise results, the following conclusions can be drawn:

\begin{enumerate}
    \item \textbf{Series Chopper:} Best suited for scenarios with low load resistance and where switching speed is not critical. It offers low net error and cost-effective implementation using a single transistor.
    \item \textbf{Series-Shant Chopper:} Optimal for high load resistance and applications requiring high switching speeds with minimal switching spikes. The cancellation of switching spikes in this configuration results in superior error performance.
    \item \textbf{Shant Chopper:} Although it has better spike performance than the Series Chopper, it introduces relatively large errors, making it less favorable for most applications.
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Define a Chopper-Stabilized Amplifier:} Describe its method of operation and state the applications to which it is well-suited, providing examples. Explain the principle of operation.
    \item \textbf{Compare Chopper Configurations:} Distinguish between Series, Shant, and Series-Shant Choppers. Discuss the criteria used to select a particular configuration for specific operations.
    \item \textbf{Drift Voltage Calculation:} Given an input of 20 mV DC and a maximum drift voltage of \( 0.1 \cos(2\pi f t) \) at point Y, determine the drift voltage magnitude if the input to the AC amplifier is shorted.
    \item \textbf{Total Error in Chopper-Stabilized System:} Calculate the overall error considering modulators, AC amplifiers, and demodulators. Discuss how to mitigate these errors to improve system performance.
\end{enumerate}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{CircuitImplementation.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{CELL.png}
